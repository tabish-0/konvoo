...
const NotificationsPage = () => {
  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8 lg:pl-50 bg-white dark:bg-gray-950 min-h-screen transition-colors">
            ...
            {incomingRequests.length > 0 && (
              <section className="space-y-5">
                <h2 className="text-xl font-semibold flex items-center gap-2 bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent">
                  ...
                  Friend Requests
                  <span className="ml-2 px-2 py-0.5 rounded-full bg-indigo-100 dark:bg-indigo-950 text-indigo-600 dark:text-indigo-300 text-xs font-medium">
                ...
                <div className="space-y-4">
                  {incomingRequests.map((request) => (
                    <div
                      key={request._id}
                      className="card rounded-xl bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 shadow-sm hover:shadow-md transition-shadow"
                    >
                          ...
                          <div className="flex items-center gap-4">
                            ...
                            <div>
                              ...
                              <div className="flex flex-wrap gap-2 mt-1 text-xs">
                                <span className="px-2 py-0.5 rounded-full bg-indigo-50 dark:bg-indigo-950 text-indigo-600 dark:text-indigo-300">
                                  Native: {request.sender.nativeLanguage}
                                </span>
                                <span className="px-2 py-0.5 rounded-full bg-purple-50 dark:bg-purple-950 text-purple-600 dark:text-purple-300">
                        ...
                        <div className="flex items-start gap-4">
                          ...
                          <div className="w-12 h-12 rounded-full p-[2px] bg-gradient-to-r from-green-500 to-emerald-500">
                            <img
                              ...
                              onError={(e) => handleAvatarError(e, notification.recipient.fullName)}
                              className="rounded-full w-full h-full object-cover"
                            />
                          </div>
                          ...
                          <div className="flex-1">
                            ...
                            <p className="text-xs flex items-center text-gray-400 dark:text-gray-500">
                          ...
                          {/* Badge */}
                          <div className="px-3 py-1 text-xs rounded-full bg-green-100 dark:bg-green-950 text-green-600 dark:text-green-300 flex items-center gap-1 font-medium">
