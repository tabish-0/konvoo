...
const LoginPage = () => {
  ...
  return (
    <div className="h-screen flex items-center justify-center px-4 sm:px-6 md:px-8">
      <div className="flex flex-col md:flex-row w-full max-w-5xl bg-white/90 backdrop-blur-lg rounded-2xl shadow-2xl overflow-hidden border border-white/20">
        ...
        <div className="w-full md:w-1/2 p-6 sm:p-10 flex flex-col justify-center">
          ...
          {/* ERROR MESSAGE */}
          {error && (
            <div className="w-full bg-red-100 text-red-700 border border-red-300 text-sm px-4 py-2 rounded-md mb-4">
        ...
        {/* IMAGE SECTION */}
        <div className="hidden md:flex w-full md:w-1/2 bg-gradient-to-br from-gray-50 to-gray-100 items-center justify-center">
